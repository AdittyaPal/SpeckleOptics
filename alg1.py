...
imageio.imwrite('image_mixed_1.jpeg', prev)
print("ER/HIOA done")
...
imageio.imwrite('image_mixed1_1.jpeg', prev)
...
ax.plot(step, sse_mixed1, color='blue', linewidth=0.5, label='(b): 12 CHIOA/HIOA(1,49) + 160 CHIOA')
#ax.plot(step, sse_mixed2, color='green', linewidth=0.5, label='(c): 12 CHIOA/HIOA(1,49) + 400 ERA')
ax.set(xlabel='Number of Iterations', ylabel='SSE in dB', title='SSE values using: (a) 12 ER/HIOA(1,49)+400 ERA, (b) 12 CHIOA/HIOA(1,49)+160 CHIOA')
ax.legend()
plt.show()
